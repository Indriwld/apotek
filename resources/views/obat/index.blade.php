 ...
 <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    data pembeli
                                    <a href="{{ route('obat.create')}}" class="btn btn-primary float-rigth">Tambah</a>
                                </div>
                                <!-- /.panel-heading -->
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                       <form action="{{route('obat.destroy',$data->id)}}" method="post">
                                                           @method('delete')
                                                           @csrf
                                                       <a href="{{ route('obat.edit',$data->id)}}" class="btn btn-success float-rigth">Ubah</a>
                                                <button type="sumbit" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin akan menghapus ini?')">Hapus</button>
                                                 <a href="transaksi/create" class="btn btn-success float-rigth">Bayar</a>
                                                 </form>
                                                   </td>
                                                </tr>
                                                @endforeach
